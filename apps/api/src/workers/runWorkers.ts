...
import { CodeforcesContestSyncJob, JudgeSubmissionJob, QUEUE_NAMES } from '../queues/jobTypes';
...
export function startQueueWorkers(io?: Server) {
  ...
  startedWorkers = { judgeWorker, externalSyncWorker };
  console.log('BullMQ workers initialized successfully for judge and external sync queues.');
